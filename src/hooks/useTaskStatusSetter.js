...
const _modalProps = {
  ...
  styles: { content: { marginHorizontal: 10, marginTop: 10, paddingTop: 0, paddingBottom: 10 } },
  closeIcon: false,
  padding: 0,
};
const statusBtn = {
      ...
      setStatusModal({
        ...
        buttons: [
          ...
          },
          {
            ...
            style: { backgroundColor: "#fff", borderWidth: 2, color: "red", marginHorizontal: 18, marginBottom: 18, marginTop: 15 }
          },
        ],
      });
    },

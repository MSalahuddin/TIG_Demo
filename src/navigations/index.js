...
import TenantNavigator from './tenant';
...
import ViewRequest from 'pages/maintenance/ViewRequest';
import EditRequest from 'pages/maintenance/EditRequest';
...
import AddCreditCard from 'pages/rentals/AddCreditCard';
...
import RentalPaymentDetails from 'pages/rentals/RentalPaymentDetails';
  ...
  return (
    <NavigationContainer
      ...
      <RootStack.Navigator
        ...
        {token && user?.id ? (
          user.userType === USER_TYPES.TENANT ? (
            <>
              ...
              <RootStack.Screen name="RentalPaymentDetails" component={RentalPaymentDetails} />
              <RootStack.Screen
                name="AddCreditCard"
        ...
        <RootStack.Screen name="ResetPassword" component={ResetPasswordNavigator} />
        ...
        <RootStack.Screen name="TermsOfUse" component={TermsOfUse} />
        <RootStack.Screen name="PrivacyPolicy" component={PrivacyPolicy} />
        <RootStack.Screen name='GenericSelectScreen' component={GenericSelectScreen} />


        {/* Financials */}
        <RootStack.Screen name="TransactionDetails" component={TransactionDetails} />
        <RootStack.Screen name="ViewAllTransactions" component={ViewAllTransactions} />

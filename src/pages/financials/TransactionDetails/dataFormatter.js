...
const getTransactionDetailedCardsData = (data = {}, isOutstanding, onViewAllTransactions, isIncoming) => {
  if (!data) return []
  return compact([
    isIncoming && {
    label: 'Tenant',
    content: {
      ...
      onPress: () => onViewAllTransactions({ payer: data.payer?.pk, isOverdue: isOutstanding}),
    },

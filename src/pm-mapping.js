...
module.exports = {
  strict: {
    'text-font-family': 'Geogrotesque-Regular',
    ...
    'text-heading-1-font-family': 'Geogrotesque-Bold',
    ...
    'text-heading-2-font-family': 'Geogrotesque-Bold',
    ...
    'text-heading-3-font-family': 'Geogrotesque-SemiBold',
    ...
    'text-heading-4-font-family': 'Geogrotesque-SemiBold',
    'text-heading-5-font-family': 'Geogrotesque-Bold',
    ...
    'text-heading-6-font-family': 'Geogrotesque-Bold',
    ...
    'text-subtitle-1-font-family': 'Geogrotesque-Bold',
    ...
    'text-subtitle-2-font-family': 'Geogrotesque-Bold',
    ...
    'text-subtitle-3-font-family': 'Geogrotesque-SemiBold',
    ...
    'text-paragraph-1-font-family': 'Geogrotesque-Regular',
    ...
    'text-paragraph-2-font-family': 'Geogrotesque-Regular',
    ...
    'text-caption-1-font-family': 'Geogrotesque-Bold',
    ...
    'text-caption-2-font-family': 'Geogrotesque-Bold',
    ...
    'text-label-font-family': 'Geogrotesque-Bold',
    'size-tiny': 24,
    'size-small': 36,
    'size-medium': 40,
    'size-large': 48,
      ...
      appearances: {
        filled: {
          ...
          variantGroups: {
            ...
            size: {
              tiny: {
                textFontFamily: 'Geogrotesque-Bold',

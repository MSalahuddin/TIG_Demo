    ...
    return (
      <Box
        ...
        <Button
          style={headerButtonStyle}
          appearance="ghost"
          textStyle={[titleStyle, {marginHorizontal: 0}]}
          // @ts-ignore
    ...
    this.renderHeaderElement = style => {
      ...
      return (
        <CustomCalendarHeader
          ...
          lateralNavigationAllowed={
            this.props.showWeek ? false : this.isHeaderNavigationAllowed()
          }
          onTitlePress={
    ...
    ({date}, style) => {
      ...
      return (
        <Box
          ...
          <Text style={style.text}>{dateService.format(date, 'D')}</Text>
          {isOccupied ? (
            <Box
